...
struct test_exceptions
{
    ...
    {
        utility::throwing<utility::tracked<int>, ThrowToggles> content_;
    ...
    void operator()(utility::thrower & thrower, ThrowToggles) const
    {
        ...
        throwing * on_heap =
            shared::construct<throwing>(allocator, thrower, registry, 234);
        ...
        on_heap =
            shared::construct<throwing>(allocator, thrower, registry, 789);
        BOOST_CHECK_EQUAL(shared::get_count(on_heap), 0);
