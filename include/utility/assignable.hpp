...
namespace assignable_detail {
    ...
    */
    ...
    public:
        ...
        Content * object() { return reinterpret_cast<Content *>(memory()); }
    ...
    */
    ...
    public:
        ...
        void set_constructed(bool constructed) { constructed_ = constructed; }
    };
...
private:
    ...
    typedef assignable_detail::manual_optional<store_type, always_constructed>
        base_type;

    template <class... Arguments> void construct(Arguments &&... arguments)
    {
        new (this->object()) store_type(std::forward<Arguments>(arguments)...);
    }
...
public:
    ...
    assignable(typename utility::storage::pass_rvalue<Content>::type content)
    : base_type(true)
    {
    ...
    assignable & operator=(
        typename utility::storage::pass<Content>::type content)
    {
        this->assign(content);
        return *this;
    }
    ...
    assignable & operator=(
        typename utility::storage::pass_rvalue<Content>::type content)
    {
    ...
    typename storage::get<Content, assignable const &>::type content() const
    {
        assert(this->constructed());
        return *this->object();
    }
