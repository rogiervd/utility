...
namespace utility {
    ...
    */
    template <int Bits> struct throw_toggles {
        ...
        static constexpr bool throw_on_copy =
            bool (Bits & toggle_throw_on_copy);
        static constexpr bool throw_on_move =
            bool (Bits & toggle_throw_on_move);
    ...
    */
    ...
    public:
        ...
        noexcept (!Toggles::throw_on_construction)
        ...
        noexcept (!Toggles::throw_on_copy)
        ...
        noexcept (!Toggles::throw_on_move)
        ...
        noexcept (!Toggles::throw_on_copy_assign)
        {
        ...
        noexcept (!Toggles::throw_on_move_assign)
        {
    ...
    template <class Content, class Toggles>
        struct is_throwing <throwing <Content, Toggles>>
    ...
    */
        ...
        inline void check_with_some_throw_toggles (TestFunction && function)
    {
        ...
        check_all_throw_points ([&function] (thrower & t) {
            function (t, do_not_throw().set_throw_on_construction()
                .set_throw_on_copy().set_throw_on_copy_assign());
        });

        // Uncommon combination.
        check_all_throw_points ([&function] (thrower & t) {
            function (t, do_not_throw().set_throw_on_move()
            .set_throw_on_move_assign().set_throw_on_conversion());
        });

        check_all_throw_points ([&function] (thrower & t) {
            function (t, always_throw());
        });
    }
    ...
    */
    ...
    {
        check_all_throw_points ([&function] (thrower & t)
            { function (t, throw_toggles <0>()); });

        check_all_throw_points ([&function] (thrower & t)
            { function (t, throw_toggles <49>()); });
        check_all_throw_points ([&function] (thrower & t)
            { function (t, throw_toggles <16>()); });
        check_all_throw_points ([&function] (thrower & t)
            { function (t, throw_toggles <5>()); });
        check_all_throw_points ([&function] (thrower & t)
            { function (t, throw_toggles <32>()); });
        check_all_throw_points ([&function] (thrower & t)
            { function (t, throw_toggles <8>()); });
        check_all_throw_points ([&function] (thrower & t)
            { function (t, throw_toggles <13>()); });
        check_all_throw_points ([&function] (thrower & t)
            { function (t, throw_toggles <55>()); });
        check_all_throw_points ([&function] (thrower & t)
            { function (t, throw_toggles <17>()); });
        check_all_throw_points ([&function] (thrower & t)
            { function (t, throw_toggles <24>()); });
        check_all_throw_points ([&function] (thrower & t)
            { function (t, throw_toggles <61>()); });
        check_all_throw_points ([&function] (thrower & t)
            { function (t, throw_toggles <60>()); });
        check_all_throw_points ([&function] (thrower & t)
            { function (t, throw_toggles <46>()); });
        check_all_throw_points ([&function] (thrower & t)
            { function (t, throw_toggles <15>()); });
        check_all_throw_points ([&function] (thrower & t)
            { function (t, throw_toggles <23>()); });
        check_all_throw_points ([&function] (thrower & t)
            { function (t, throw_toggles <26>()); });
        check_all_throw_points ([&function] (thrower & t)
            { function (t, throw_toggles <63>()); });
    }
    ...
    namespace detail {
        ...
        template <> struct check_with_all_throw_toggles <-1> {
            template <class TestFunction>
                void operator() (TestFunction &&) const {}
        };
