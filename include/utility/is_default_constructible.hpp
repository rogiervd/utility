...
namespace is_default_constructible_detail {
    ...
    template <
        template <class...> class Predicate, class Type, class Enable = void>
    ...
    struct compute<Predicate, Type &> : std::integral_constant<bool, false>
    {};
    template <template <class...> class Predicate, class Type>
    struct compute<Predicate, Type &&> : std::integral_constant<bool, false>
    {};
    ...
    // Function types.
    template <
        template <class...> class Predicate, class Return, class... Arguments>
    ...
    struct compute<Predicate, void> : std::integral_constant<bool, false>
    {};

    // Abstract classes.
    template <template <class...> class Predicate, class Type> struct compute<
        Predicate, Type,
    ...
    // Arrays.
    template <template <class...> class Predicate, class Type, std::size_t N>
    struct compute<Predicate, Type[N]> : compute<Predicate, Type>
    {};
...
: is_default_constructible_detail::compute<std::is_nothrow_constructible, Type>
{};
