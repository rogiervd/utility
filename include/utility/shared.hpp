...
public:
    ...
    */
    ...
    be deleted.
    */
    static bool release_count(shared * s) noexcept { return !--s->count; }
    ...
    */
    ...
    static Type * construct(Allocator & allocator, Arguments &&... arguments)
    {
        static_assert(
            std::is_base_of<shared, Type>::value,
...
private:
    ...
    */
    ...
    template <class Type, class Allocator> class guard<Type, Allocator, true>
    {
    public:
